...
public final class PacketInStopProcess implements NetworkInboundHandler {
    ...
    public void handle(Configuration configuration) {
        if (ReformCloudClient.getInstance().getCloudProcessScreenService()
            .getRegisteredServerHandler(configuration.getStringValue("name")) != null) {
            final CloudServerStartupHandler cloudServerStartupHandler = ReformCloudClient
        ...
        } else if (ReformCloudClient.getInstance().getCloudProcessScreenService()
            .getRegisteredProxyHandler(configuration.getStringValue("name")) != null) {
            final ProxyStartupHandler proxyStartupHandler = ReformCloudClient.getInstance()
