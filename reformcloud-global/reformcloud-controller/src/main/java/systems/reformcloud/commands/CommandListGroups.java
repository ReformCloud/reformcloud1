...
public final class CommandListGroups extends Command implements Serializable {
    ...
    public void executeCommand(CommandSender commandSender, String[] args) {
        ...
        ReformCloudController.getInstance().getInternalCloudNetwork().getProxyGroups().values().forEach(e ->
                commandSender.sendMessage("    - " + e.getName() + " | Ram: " + e.getMemory() + " | ProxyModeType: " + e.getProxyModeType() + " | MinOnline: " + e.getMinOnline() + " | MaxOnline: " + e.getMaxOnline() + " | MaxPlayers: " + e.getMaxPlayers() + " | Version: " + e.getProxyVersions().getName() + " | Clients: " + e.getClients())
        );
        ...
        ReformCloudController.getInstance().getInternalCloudNetwork().getServerGroups().values().forEach(e ->
                commandSender.sendMessage("    - " + e.getName() + " | Ram: " + e.getMemory() + " | ServerModeType: " + e.getServerModeType() + " | MinOnline: " + e.getMinOnline() + " | MaxOnline: " + e.getMaxOnline() + " | MaxPlayers: " + e.getMaxPlayers() + " | Version: " + e.getSpigotVersions().getName() + " | Clients: " + e.getClients())
        );
    }
}
