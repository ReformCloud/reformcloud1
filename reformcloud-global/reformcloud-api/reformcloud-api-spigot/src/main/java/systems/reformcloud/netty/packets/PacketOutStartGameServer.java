...
public final class PacketOutStartGameServer extends Packet {
    public PacketOutStartGameServer(final ServerGroup serverGroup, final Configuration preConfiguration) {
        super("StartGameProcess", new Configuration().addProperty("group", serverGroup).addConfigurationProperty("pre", preConfiguration), Collections.singletonList(QueryType.COMPLETE), PacketSender.PROCESS_SERVER);
    }
