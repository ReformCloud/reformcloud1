...
public final class PacketOutStartProxy extends Packet {
    public PacketOutStartProxy(final ProxyGroup proxyGroup, final Configuration preConfig) {
        super("StartProxyProcess", new Configuration().addProperty("group", proxyGroup).addConfigurationProperty("pre", preConfig), Collections.singletonList(QueryType.COMPLETE), PacketSender.PROCESS_PROXY);
    }
