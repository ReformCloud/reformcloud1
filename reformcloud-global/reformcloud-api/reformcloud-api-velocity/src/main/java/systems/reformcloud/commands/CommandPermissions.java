...
public final class CommandPermissions implements Serializable, Command {
    ...
    public boolean hasPermission(CommandSource source, @NonNull String[] args) {
        ...
        System.out
            .println(source.getPermissionValue("reformcloud.command.permissions").asBoolean());
    ...
    private List<String> groupNames() {
        List<String> out = new LinkedList<>();
        ReformCloudAPIVelocity.getInstance().getPermissionCache().getAllGroupsAndDefault()
