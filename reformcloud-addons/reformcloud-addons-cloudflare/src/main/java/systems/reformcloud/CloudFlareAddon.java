...
public final class CloudFlareAddon extends ControllerAddonImpl implements Serializable {
    ...
    public void onAddonLoading() {
        ...
        ReformCloudController.getInstance().getEventManager()
            .registerListener(clientCreatedListener);
        ReformCloudController.getInstance().getEventManager()
            .registerListener(clientDeletedListener);
        ReformCloudController.getInstance().getEventManager()
            .registerListener(proxyStartedListener);
        ReformCloudController.getInstance().getEventManager()
            .registerListener(proxyStoppedListener);
    }
    ...
    public void onAddonReadyToClose() {
        ...
        ReformCloudController.getInstance().getEventManager()
            .unregisterListenerByClassLoader(clientCreatedListener.getClass().getClassLoader());
        ReformCloudController.getInstance().getEventManager()
            .unregisterListenerByClassLoader(clientDeletedListener.getClass().getClassLoader());
        ReformCloudController.getInstance().getEventManager()
            .unregisterListenerByClassLoader(proxyStartedListener.getClass().getClassLoader());
        ReformCloudController.getInstance().getEventManager()
            .unregisterListenerByClassLoader(proxyStoppedListener.getClass().getClassLoader());
    }
}
