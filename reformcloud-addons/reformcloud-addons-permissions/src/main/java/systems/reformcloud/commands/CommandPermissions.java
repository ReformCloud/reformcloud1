...
public final class CommandPermissions extends Command implements Serializable {
    ...
    public CommandPermissions() {
        super("permissions", "Manage the permissions", "reformcloud.commands.permissions",
            new String[]{"perms"});
    }
    ...
    public void executeCommand(CommandSender commandSender, String[] args) {
        if (args.length == 1 && args[0].equalsIgnoreCase("list")) {
            ...
            registered.forEach(permissionGroup -> stringBuilder
                ...
                .append("/Default=")
                .append(PermissionsAddon.getInstance().getPermissionDatabase().getPermissionCache()
                    .getDefaultGroup().getName().equals(permissionGroup.getName()))
            );
            ...
            if (PermissionsAddon.getInstance().getPermissionDatabase().getPermissionCache()
                .getDefaultGroup()
            ...
            PermissionHolder permissionHolder = PermissionsAddon.getInstance()
                .getPermissionDatabase().getPermissionHolder(uuid);
            ...
            commandSender.sendMessage(
                "  - " + args[0] + "/Groups=" + permissionHolder.getPermissionGroups() +
            ...
            permissionHolder.getPlayerPermissions()
            ...
            commandSender
                .sendMessage("The permission " + args[2] + " was removed from the user " + args[0]);
            ...
            commandSender
                .sendMessage("Set " + args[0] + "'s group to " + permissionGroup.getName());
            ...
            PermissionsAddon.getInstance().getPermissionDatabase().getPermissionCache()
                .getAllRegisteredGroups().remove(permissionGroup);
            PermissionsAddon.getInstance().getPermissionDatabase().getPermissionCache()
                .setDefaultGroup(permissionGroup);
            PermissionsAddon.getInstance().getPermissionDatabase().update();

            commandSender
                .sendMessage("Successfully set the default group to " + permissionGroup.getName());
            ...
            long timeout =
                System.currentTimeMillis() + TimeUnit.DAYS.toMillis(Long.parseLong(args[3]));
            ...
            commandSender
                .sendMessage("Successfully set the prefix to " + permissionGroup.getPrefix());
            ...
            PermissionsAddon.getInstance().getPermissionDatabase()
                .updatePermissionGroup(permissionGroup);
            commandSender
                .sendMessage("Successfully set the display to " + permissionGroup.getDisplay());
            ...
            PermissionsAddon.getInstance().getPermissionDatabase()
                .updatePermissionGroup(permissionGroup);
            commandSender
                .sendMessage("Successfully set the suffix to " + permissionGroup.getSuffix());
            ...
            PermissionsAddon.getInstance().getPermissionDatabase()
                .updatePermissionGroup(permissionGroup);
            commandSender.sendMessage(
                "Successfully set the tabcolorcode to " + permissionGroup.getTabColorCode());
            ...
            commandSender
                .sendMessage("perms <USERNAME> <ADDGROUP/REMOVEGROUP/SETGROUP> <GROUPNAME>");
            commandSender
