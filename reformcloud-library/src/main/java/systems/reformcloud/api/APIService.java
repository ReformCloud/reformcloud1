...
public interface APIService extends Serializable, SnapshotAble {
     ...
     */
    AtomicReference<APIService> instance = new AtomicReference<>();

    /**
     * Starts a game server
     *
     * @param serverGroupName The name of the ServerGroup you want to start a server of
     */
     ...
     *
     * @param serverGroupName The name of the ServerGroup you want to start a server of
     * @param preConfig The preConfig which will be saved while starting up the process
     */
     ...
     * Starts a game server
     *
     * @param serverGroup The specific ServerGroup you want to start a server of
     */
     ...
     * @param serverGroup The specific ServerGroup you want to start a server of
     * @param preConfig The preConfig which will be saved while starting up the process
     * @param template The specific template the server should start with
     */
     ...
     * Starts a proxy
     *
     * @param proxyGroupName The name of the ProxyGroup you want to start a proxy of
     */
     ...
     * Starts a proxy
     *
     * @param proxyGroup The exact ProxyGroup you want to start a process of
     */
     ...
     * @param proxyGroup The exact ProxyGroup you want to start a process of
     * @param preConfig The preConfig which will be saved while starting up the process
     * @param template The exact template that should be loaded while starting up the process
     */
