...
public final class SignLayout implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SignLayout)) {
            return false;
        }
        final SignLayout other = (SignLayout) o;
        if (!java.util.Arrays.deepEquals(this.getLines(), other.getLines())) {
            return false;
        }
        ...
        if (this.getMaterialData() != other.getMaterialData()) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "SignLayout(lines=" + java.util.Arrays.deepToString(this.getLines())
            + ", materialName=" + this.getMaterialName() + ", materialData=" + this
            .getMaterialData() + ")";
    }
    ...
    public static class LoadingLayout {
        ...
        public boolean equals(final Object o) {
            ...
            if (this.getPerSecondAnimation() != other.getPerSecondAnimation()) {
                return false;
            }
            if (!java.util.Arrays.deepEquals(this.getLayouts(), other.getLayouts())) {
                return false;
            }
            return true;
        }
        ...
        public String toString() {
            return "SignLayout.LoadingLayout(perSecondAnimation=" + this.getPerSecondAnimation()
                + ", currentAnimation=" + this.getCurrentAnimation() + ", layouts="
                + java.util.Arrays.deepToString(this.getLayouts()) + ")";
        }
    }
    ...
    public static class GroupLayout {
        ...
        @java.beans.ConstructorProperties({"maintenanceLayout", "emptyLayout", "fullLayout",
            "onlineLayout"})
        public GroupLayout(SignLayout maintenanceLayout, SignLayout emptyLayout,
            SignLayout fullLayout, SignLayout onlineLayout) {
        ...
        public int hashCode() {
            ...
            result =
                result * PRIME + ($maintenanceLayout == null ? 43 : $maintenanceLayout.hashCode());
        ...
        public String toString() {
            return "SignLayout.GroupLayout(maintenanceLayout=" + this.getMaintenanceLayout()
                + ", emptyLayout=" + this.getEmptyLayout() + ", fullLayout=" + this.getFullLayout()
                + ", onlineLayout=" + this.getOnlineLayout() + ")";
        }
    }
    ...
    public static class TemplateLayout {
        ...
        public TemplateLayout(SignLayout emptyLayout, SignLayout fullLayout,
            SignLayout onlineLayout) {
            this.emptyLayout = emptyLayout;
            this.fullLayout = fullLayout;
            this.onlineLayout = onlineLayout;
        }
        ...
        public boolean equals(final Object o) {
            ...
            if (!(o instanceof TemplateLayout)) {
                return false;
            }
        ...
        public String toString() {
            return "SignLayout.TemplateLayout(emptyLayout=" + this.getEmptyLayout()
                + ", fullLayout=" + this.getFullLayout() + ", onlineLayout=" + this
                .getOnlineLayout() + ")";
        }
    }
}
