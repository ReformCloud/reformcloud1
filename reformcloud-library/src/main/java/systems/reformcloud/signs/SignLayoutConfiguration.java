...
public final class SignLayoutConfiguration implements Serializable {
    ...
    @java.beans.ConstructorProperties({"defaultLayout", "groupLayouts", "groupTemplateLayouts",
        "loadingLayout"})
    public SignLayoutConfiguration(SignLayout.GroupLayout defaultLayout,
        Map<String, SignLayout.GroupLayout> groupLayouts,
        List<TemplateMap<String, String, SignLayout.TemplateLayout>> groupTemplateLayouts,
        SignLayout.LoadingLayout loadingLayout) {
